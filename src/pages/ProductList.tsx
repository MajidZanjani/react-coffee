      ...
      <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {products.map((product) => (
          <div
            ...
            className="group flex flex-col justify-between border border-border-light rounded-2xl p-4 shadow-sm transition-all duration-500 hover:shadow-coffee hover:shadow-xl/50 hover:-translate-y-2 cursor-pointer"
          >
